 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Alex");
		  toPrint += p1.toString("agurung7");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Jaden");
		  toPrint += p2.toString("jwest75");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Aman");
		  toPrint += p3.toString("ajain471");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Theresa");
                  toPrint += p4.toString("thsieh37");
...
<<<<<<< HEAD
>>>>>>> 5f4b2a9f01d3ff101c3aa91c89226ca25bae9d3c
=======
>>>>>>> 1ec71be9c4a00fb8f4c44323d2f5a21d5f7db2f7
